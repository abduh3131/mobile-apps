...
import com.example.foodorder.ui.FoodSelectionAdapter
...
class FoodOrderActivity : AppCompatActivity() {
    ...
    // handles checkbox toggles and enforces target
    ...
    // saves selected items as a plan
